...
class MoviesScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: commonAppBar("Recommended Movies"),
      body: SafeArea(
        child: Padding(
            ...
            children: [
              ...
              Expanded(
                child: Builder(builder: (context) {
                  if (recommendedState.isLoading && recommendedMovies.isEmpty) {
                  ...
                  return ApiGridWidget(
                    ...
                    canLoadMore: canLoadMoreRecommendedMoviesProvider,
                    scrollController: scrollController,
                    emptyCondition: !recommendedState.isLoading &&
                        recommendedMovies.isEmpty,
