...
abstract class _$$UpcomingMoviesStateImplCopyWith<$Res>
    implements $UpcomingMoviesStateCopyWith<$Res> {
  factory _$$UpcomingMoviesStateImplCopyWith(_$UpcomingMoviesStateImpl value,
...
class __$$UpcomingMoviesStateImplCopyWithImpl<$Res>
  ...
  __$$UpcomingMoviesStateImplCopyWithImpl(_$UpcomingMoviesStateImpl _value,
  ...
  $Res call({
    ...
    return _then(_$UpcomingMoviesStateImpl(
      isLoading: null == isLoading
          ? _value.isLoading
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$UpcomingMoviesStateImpl implements _UpcomingMoviesState {
  ...
  @override
  String toString() {
    return 'UpcomingMoviesState(isLoading: $isLoading, data: $data, error: $error, currentPage: $currentPage)';
  }
...
abstract class _UpcomingMoviesState implements UpcomingMoviesState {
  const factory _UpcomingMoviesState(
      ...
      final MovieListModel? data,
      final String? error,
      final int currentPage}) = _$UpcomingMoviesStateImpl;
